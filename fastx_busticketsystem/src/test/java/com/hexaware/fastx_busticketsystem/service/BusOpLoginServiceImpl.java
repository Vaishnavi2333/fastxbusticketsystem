 ...
 * @SpringBootTest
 * 
 * @Slf4j public class BusOpLoginServiceImpl {
 * 
 * @Autowired private IBusOpLoginService service;
 * 
 * 
 * @Test void testRegisterBusOperator() throws BusOperatorAlreadyExistsException
 * { log.info("Starting testRegisterBusOperator...");
 * 
 * BusOpLoginDto dto = new BusOpLoginDto(); dto.setUsername("Hamza"); //
 ...
 * 
 * @Test void testLoginBusOperator() throws BusOperatorNotFoundException {
 * log.info("Starting testLoginBusOperator...");
 * 
 * String username = "Hamza"; String password = "hamza123";
 * 
 * log.info("Logging in bus operator: {}", username);
 * 
 * String result = service.loginBusOp(username, password);
 * 
 * log.info("Login result: {}", result); assertNotNull(result);
